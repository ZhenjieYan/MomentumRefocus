...
bgimages={'03-24-2016_21_00_00_top';'03-24-2016_20_59_09_top';'03-24-2016_20_58_18_top'};
output=momentumfocusRV(momimages,bgimages,'Nbins' ,60,'SM',4,'IfFourierFilter',1);
...
%bgimages={};
%output=momentumfocusRV(momimages,bgimages,'Nbins' ,60,'SM',4,'IfFourierFilterBG',1,'CutOffFactor',0.05);
output=momentumfocusRV(momimages,bgimages,'Nbins' ,60,'SM',4);
%%
kFNlist=[kFNlist,output.kF_num]
kFFitlist=[kFFitlist,output.kF_Fit]
...
output=momentumfocusRV(momimages,bgimages,'Nbins' ,50,'SM',3,'Fudge',1,'Nsat',inf);
